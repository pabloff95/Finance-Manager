<?php
    ...
    function fillCategoryIncomeTable(){
        ...
        if (isset($_POST['edit'])){
            echo "<form action='management.php?data=categoriesincome' method='POST' id='changeCategoryForm'> </form>";
        }
    }
      ...
      function recordFormatIncomeCat($row){
        if (isset($_POST['edit']) && ($_POST['editId']) == $row['id']){
            ...
            echo "
                    ...
                    <td><input type='submit' value='Change' name='changeCatIncome' form='changeCategoryForm'></td>                                      
                  <td>
            ...
            echo "<td>".$row['category']."</td>
                  <td><form action='management.php?data=categoriesincome' method='POST'>
                  ...
                  <td>
                    <form action='management.php?data=categoriesincome' method='POST'>
                        <input type='submit' value='Delete' name='deleteCatIncome'>
